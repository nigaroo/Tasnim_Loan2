...
namespace Tasnim_Loan.Persistence.Migrations
{
    ...
    [Migration("20230901141902_accepttypes")]
    partial class accepttypes
    {
            ...
            modelBuilder.Entity("Tasnim_Loan.Domain.Entities.Loans.Typee", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            InsertTime = new DateTime(2023, 9, 1, 17, 49, 0, 239, DateTimeKind.Local).AddTicks(258),
                            IsRemoved = false,
                            Name = "treatment"
                        },
                        new
                        {
                            ID = 2,
                            InsertTime = new DateTime(2023, 9, 1, 17, 49, 0, 239, DateTimeKind.Local).AddTicks(2623),
                            IsRemoved = false,
                            Name = "Housing"
                        },
                        new
                        {
                            ID = 3,
                            InsertTime = new DateTime(2023, 9, 1, 17, 49, 0, 239, DateTimeKind.Local).AddTicks(2719),
                            IsRemoved = false,
                            Name = "Others"
                        });
                });
            ...
            modelBuilder.Entity("Tasnim_Loan.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            InsertTime = new DateTime(2023, 9, 1, 17, 49, 0, 226, DateTimeKind.Local).AddTicks(7177),
                            IsRemoved = false,
                            Name = "Admin"
                        },
                        new
                        {
                            ID = 2,
                            InsertTime = new DateTime(2023, 9, 1, 17, 49, 0, 238, DateTimeKind.Local).AddTicks(7662),
                            IsRemoved = false,
                            Name = "Operator"
                        },
                        new
                        {
                            ID = 3,
                            InsertTime = new DateTime(2023, 9, 1, 17, 49, 0, 238, DateTimeKind.Local).AddTicks(8144),
                            IsRemoved = false,
                            Name = "Customer"
                        });
                });
