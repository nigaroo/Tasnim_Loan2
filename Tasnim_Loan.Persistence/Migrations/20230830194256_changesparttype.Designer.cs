...
namespace Tasnim_Loan.Persistence.Migrations
{
    ...
    [Migration("20230830194256_changesparttype")]
    partial class changesparttype
    {
            ...
            modelBuilder.Entity("Tasnim_Loan.Domain.Entities.Loans.Typee", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            InsertTime = new DateTime(2023, 8, 30, 23, 12, 53, 783, DateTimeKind.Local).AddTicks(6658),
                            IsRemoved = false,
                            Name = "treatment"
                        },
                        new
                        {
                            ID = 2,
                            InsertTime = new DateTime(2023, 8, 30, 23, 12, 53, 783, DateTimeKind.Local).AddTicks(9202),
                            IsRemoved = false,
                            Name = "Housing"
                        },
                        new
                        {
                            ID = 3,
                            InsertTime = new DateTime(2023, 8, 30, 23, 12, 53, 783, DateTimeKind.Local).AddTicks(9291),
                            IsRemoved = false,
                            Name = "Others"
                        });
                });
            ...
            modelBuilder.Entity("Tasnim_Loan.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            InsertTime = new DateTime(2023, 8, 30, 23, 12, 53, 768, DateTimeKind.Local).AddTicks(4809),
                            IsRemoved = false,
                            Name = "Admin"
                        },
                        new
                        {
                            ID = 2,
                            InsertTime = new DateTime(2023, 8, 30, 23, 12, 53, 783, DateTimeKind.Local).AddTicks(3368),
                            IsRemoved = false,
                            Name = "Operator"
                        },
                        new
                        {
                            ID = 3,
                            InsertTime = new DateTime(2023, 8, 30, 23, 12, 53, 783, DateTimeKind.Local).AddTicks(3906),
                            IsRemoved = false,
                            Name = "Customer"
                        });
                });
