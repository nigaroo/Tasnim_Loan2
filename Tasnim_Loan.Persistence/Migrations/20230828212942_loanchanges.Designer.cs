...
namespace Tasnim_Loan.Persistence.Migrations
{
    ...
    [Migration("20230828212942_loanchanges")]
            ...
            modelBuilder.Entity("Tasnim_Loan.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            InsertTime = new DateTime(2023, 8, 29, 0, 59, 39, 563, DateTimeKind.Local).AddTicks(8009),
                            IsRemoved = false,
                            Name = "Admin"
                        },
                        new
                        {
                            ID = 2,
                            InsertTime = new DateTime(2023, 8, 29, 0, 59, 39, 576, DateTimeKind.Local).AddTicks(9436),
                            IsRemoved = false,
                            Name = "Operator"
                        },
                        new
                        {
                            ID = 3,
                            InsertTime = new DateTime(2023, 8, 29, 0, 59, 39, 577, DateTimeKind.Local).AddTicks(4),
                            IsRemoved = false,
                            Name = "Customer"
                        });
                });
