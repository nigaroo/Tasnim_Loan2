...
namespace Tasnim_Loan.Persistence.Migrations
{
    ...
    [Migration("20230830185407_typeloan")]
    partial class typeloan
    {
            ...
            modelBuilder.Entity("Tasnim_Loan.Domain.Entities.Loans.Typee", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            InsertTime = new DateTime(2023, 8, 30, 22, 24, 5, 355, DateTimeKind.Local).AddTicks(6753),
                            IsRemoved = false,
                            Name = "treatment"
                        },
                        new
                        {
                            ID = 2,
                            InsertTime = new DateTime(2023, 8, 30, 22, 24, 5, 356, DateTimeKind.Local).AddTicks(1364),
                            IsRemoved = false,
                            Name = "Housing"
                        },
                        new
                        {
                            ID = 3,
                            InsertTime = new DateTime(2023, 8, 30, 22, 24, 5, 356, DateTimeKind.Local).AddTicks(1622),
                            IsRemoved = false,
                            Name = "Others"
                        });
                });
            ...
            modelBuilder.Entity("Tasnim_Loan.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            InsertTime = new DateTime(2023, 8, 30, 22, 24, 5, 146, DateTimeKind.Local).AddTicks(393),
                            IsRemoved = false,
                            Name = "Admin"
                        },
                        new
                        {
                            ID = 2,
                            InsertTime = new DateTime(2023, 8, 30, 22, 24, 5, 355, DateTimeKind.Local).AddTicks(676),
                            IsRemoved = false,
                            Name = "Operator"
                        },
                        new
                        {
                            ID = 3,
                            InsertTime = new DateTime(2023, 8, 30, 22, 24, 5, 355, DateTimeKind.Local).AddTicks(2052),
                            IsRemoved = false,
                            Name = "Customer"
                        });
                });
