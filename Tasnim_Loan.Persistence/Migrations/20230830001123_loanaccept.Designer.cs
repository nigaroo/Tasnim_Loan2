...
namespace Tasnim_Loan.Persistence.Migrations
{
    ...
    [Migration("20230830001123_loanaccept")]
    partial class loanaccept
    {
            ...
            modelBuilder.Entity("Tasnim_Loan.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            InsertTime = new DateTime(2023, 8, 30, 3, 41, 20, 634, DateTimeKind.Local).AddTicks(378),
                            IsRemoved = false,
                            Name = "Admin"
                        },
                        new
                        {
                            ID = 2,
                            InsertTime = new DateTime(2023, 8, 30, 3, 41, 20, 647, DateTimeKind.Local).AddTicks(6445),
                            IsRemoved = false,
                            Name = "Operator"
                        },
                        new
                        {
                            ID = 3,
                            InsertTime = new DateTime(2023, 8, 30, 3, 41, 20, 647, DateTimeKind.Local).AddTicks(6952),
                            IsRemoved = false,
                            Name = "Customer"
                        });
                });
