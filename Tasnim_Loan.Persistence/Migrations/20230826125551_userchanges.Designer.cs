...
namespace Tasnim_Loan.Persistence.Migrations
{
    ...
    [Migration("20230826125551_userchanges")]
            ...
            modelBuilder.Entity("Tasnim_Loan.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            InsertTime = new DateTime(2023, 8, 26, 16, 25, 49, 420, DateTimeKind.Local).AddTicks(2966),
                            IsRemoved = false,
                            Name = "Admin"
                        },
                        new
                        {
                            ID = 2,
                            InsertTime = new DateTime(2023, 8, 26, 16, 25, 49, 434, DateTimeKind.Local).AddTicks(3942),
                            IsRemoved = false,
                            Name = "Operator"
                        },
                        new
                        {
                            ID = 3,
                            InsertTime = new DateTime(2023, 8, 26, 16, 25, 49, 434, DateTimeKind.Local).AddTicks(4457),
                            IsRemoved = false,
                            Name = "Customer"
                        });
                });
